#include "StampaScadenze.h"
#include <iostream>
#include "../settingsmanager.h"
#include <QtWidgets>

StampaScadenze::StampaScadenze(QObject *parent) : QObject(parent) 
{
...
StampaScadenze::~StampaScadenze()
{
    delete printer;
}

void StampaScadenze::stampaScadenze(QPrinter* printer, QSqlQueryModel* model, 
                                  QTextDocument* docu)
{
    ...
    while(rec < model->rowCount())
    {
        for (int secRow = 0; secRow < model->rowCount(); ++secRow)
        {
            ...
            if(!record.isEmpty())
            {
                ...
                htmlRow += QString("</td>");
                htmlRow += QString("<td width=\"100\" >");
                htmlRow += QString("<p align=\"left\"><font size=\"1.5\" style=\"font-size: 10pt\">"+record.value("rientro").toString()+"</font></p>");
                htmlRow += QString("</td>");
            rec++;
        }
        }
        stampaScadenzePag(pag, docu, printer);
...
void StampaScadenze::stampaScadenzePag(int pagina, QTextDocument *docu,  QPrinter *printer)
{
    ...
    "<table width=\"100\" cellpadding=\"0\" cellspacing=\"0\" border=\"0.5\">"
        ...
        "<tr valign=\"top\">"
            ...
            "</td>"
            "<td width=\"100\" >"
                "<p align=\"left\" ><font size=\"1.5\" style=\"font-size: 10pt\"><b>Libro prestato</b></font></p>"
            "</td>"
            "<td width=\"100\" >"
            ...
            "</td>"
            "<td width=\"100\" >"
                "<p align=\"left\"><font size=\"1.5\" style=\"font-size: 10pt\"><b>Rientrato/Non rientrato</b></font></p>"
            "</td>"
        "</tr>");
        html += htmlRow;
