...
Remove-Item logman\CMakeFiles -Recurse -Force
Remove-Item primanota\CMakeFiles -Recurse -Force
Remove-Item utility\database\CMakeFiles -Recurse -Force
Remove-Item update\CMakeFiles -Recurse -Force
Remove-Item smtp\CMakeFiles -Recurse -Force
Remove-Item poppler_pdf\CMakeFiles -Recurse -Force
...
echo "Rimozione file exe"
Get-ChildItem  -Include *.exe -Recurse | foreach { $_.Delete()}